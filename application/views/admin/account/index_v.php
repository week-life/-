						...
						<div class="card adaptable-card">
							<div class="card-body">
								...
								<div class="card card-border mb-5">
									<div class="card-body">
										<h6 class="truncate mb-4"><span class="mc-txt">계좌 정보</span></h6>
										<hr class="mb-5"></hr>

                                        <div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											<div class="font-semibold">은행명</div>
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name='bank' class="input input-sm required" value="<?php echo $data->bank; ?>">
											</div>
										</div>

										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											<div class="font-semibold">계좌번호</div>
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name='account_number' class="input input-sm required" value="<?php echo $data->account_number; ?>">
											</div>
										</div>

										<div class="grid md:grid-cols-3 gap-4 py-2 items-center">
											<div class="font-semibold">예금주</div>
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name='account_holder' class="input input-sm required" value="<?php echo $data->account_holder; ?>">
											</div>
										</div>
