									...
									<div class="card-body">
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2">
												<select name="service_idx" class="input input-sm input-short">
													...
													<option value="<?php echo $val->idx; ?>"><?php echo $val->name; ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name="min_by_cnt" class="input input-sm input-short required"><span>장</span>
											</div>
										</div>
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name="max_by_cnt" class="input input-sm input-short required"><span>장</span>
											</div>
										</div>
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name="limit_unit" class="input input-sm input-short required"><span>장 단위</span>
											</div>
										</div>
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 items-center">
											...
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name="price" class="input input-sm input-short required"><span>원</span>
											</div>
										</div>
									</div>
								</div>
