								...
								<div class="card card-border mb-5">
									<div class="card-body">
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2">
												<label class="checkbox-label">
													<input class="checkbox" type="checkbox" name="dn" value="1" >
													<span>사용</span>
												</label>
											</div>
										</div>
                                        <div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2">
												<label class="checkbox-label">
													<input class="checkbox" type="checkbox" name="cp" value="1"  >
													<span>사용안함</span>
												</label>
											</div>
										</div>
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2">
												<input type="text" name="name" class="input input-sm input-short required">
											</div>
										</div>
										...
										<div class="grid md:grid-cols-3 gap-4 py-2 border-b border-gray-200 dark:border-gray-600 items-center">
											...
											<div class="col-span-2 flex items-center gap-1">
												<input type="text" name="price" class="input input-sm input-short required numbersOnly"><span>원</span>
											</div>
										</div>
										<div class="grid md:grid-cols-3 gap-4 py-2 items-center">
											<div class="font-semibold">내용</div>
											<div class="col-span-2 flex items-center gap-1">
												<textarea name='memo' class="input input-textarea required"></textarea>
											</div>
										</div>
									</div>
								</div>
