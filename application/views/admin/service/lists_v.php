	...
	<div class="page-container relative h-full flex flex-auto flex-col px-4 sm:px-6 md:px-8 py-4 sm:py-6">
		<div class="flex flex-col gap-4 h-full">
			...
			<div class="flex flex-wrap items-center justify-between gap-1">
				...
				<a href="/<?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>/add" class="btn btn-solid btn-sm black-btn items-center flex w-100">대낙 서비스 추가하기</a>
			</div>
							...
							<thead>
								...
								<tbody>
									...
									<tr>
										...
										<td><?php if($val->cp){ echo "사용안함"; } ?></td>
										<td><?php if($val->dn){ echo "사용"; } ?></td>
										<td><span class=" font-semibold text-emerald-500"><?php echo $val->name; ?></span></td>
										<td><?php echo number_format($val->price); ?>원</td>
										<td>
