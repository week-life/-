        ...
        <div class="content-box">
            <div class="input-wrap">
                ...
                <div class="box">
                    <p>비밀번호</p>
					<div class="flex-box">
                        <input type="password" name="userPassword" onkeyup="checkReg(event)" class="input-password" placeholder="비밀번호를 입력해주세요." required>
        ...
        <div class="content-box">
            ...
            <div class="input-wrap">
                ...
                <div class="box">
					...
					<div class="flex-box">
                        <input type="password" onkeyup="checkReg(event)" name="userPassword" class="input-password" placeholder="비밀번호를 입력해주세요." required>
                        <button type="button" class="pw-btn"></button>
                    </div>
                </div>
                <div class="box">
            ...
            <div class="input-wrap">
                ...
                <div class="box">
					...
					<div class="box">
						...
						<input type="text" onkeyup="checkReg(event)" name="gamePassword" placeholder="게임 비밀번호를 입력해주세요 (한글 입력 불가)" required>
					</div>
					<div class="box">
        ...
        <div class="content-box">
            ...
            <div class="input-wrap">
                ...
                <div class="box">
                    <p class="required">비밀번호</p>
					<div class="flex-box">
                        <input type="password" name="userPassword" class="input-password" placeholder="비밀번호를 입력해주세요." required>
                        <button type="button" class="pw-btn"></button>
                    </div>
                </div>
                <div class="box">
           ...
           <div class="input-wrap">
                ...
                <div class="box">
                    <p class="bc-txt required">게임 비밀번호</p>
					<input type="text" onkeyup="checkReg(event)" name="gamePassword" value="<?php echo $member->gamePassword; ?>" placeholder="게임 비밀번호를 입력해주세요." required>
                </div>
                <div class="box">
                    <p class="bc-txt required">2차 비밀번호</p>
