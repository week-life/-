 ...
 $(function () {
	...
	if(area != 1)
	{
	 ...
	 $("#login_type").change(function(){
		...
		$('#gamePassword').eq(0).attr("required", true);
		...
		if(area == 6)
		{
			...
			$('#gamePassword').eq(0).attr("required", false);
	...
	$("#loginForm").submit(function(){
		...
		formData.append("userPassword", base64EncodeUnicode($("#userPassword3").val()));
		$.ajax({
			url:"/member/login",
			type:'post',
			dataType:"JSON",
	...
	$("#requestForm").submit(function(){		
		...
		var formData = new FormData(form);  	
		formData.append("gamePassword", base64EncodeUnicode($("#gamePassword").val()));
		$.ajax({
			url:"/order/proc",
			type:'post',
			dataType:"JSON",
	...
	$("#requestForm2").submit(function(){		
		...
		var form = $('#requestForm2')[0];  	
		var formData = new FormData(form);  	
		//formData.append("gamePassword", encodeURIComponent($("#gamePassword").val()));
		formData.append("gamePassword", base64EncodeUnicode($("#gamePassword").val()));
	 ...
	 $("#modifyForm").submit(function(){
		...
		var userPassword = ﻿$('#userPassword4');
		...
		var formData = new FormData(form);  
		formData.append("userPassword", base64EncodeUnicode($("#userPassword4").val()));
		formData.append("gamePassword", base64EncodeUnicode($("#gamePassword7").val()));
	 ...
	 $("#signUpForm").submit(function(){
		...
		var formData = new FormData(form);  
		formData.append("userPassword", base64EncodeUnicode($("#userPassword").val()));
		formData.append("gamePassword", base64EncodeUnicode($("#gamePassword2").val()));
