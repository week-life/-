	...
	public function create_links()
	{
		...
		if ($this->prev_link !== FALSE && $this->cur_page !== 1)
		{
			...
			if ($i === $base_page)
			{
                ...
                */
                $output .= '<a class="prev page-numbers" href="'.$first_url.'"'.$attributes.$this->_attr_rel('prev').'>prev</a>';
			}
			else
			{
                $append = $this->prefix.$i.$this->suffix;              
                $output .= '<a class="prev page-numbers" href="'.$base_url.$append.'"'.$attributes.$this->_attr_rel('prev').'>prev</a>';
			...
			for ($loop = $start - 1; $loop <= $end; $loop++)
			{
				...
				if ($i >= $base_page)
				{
					...
					*/
					...
					{
                        $append = $this->prefix.$i.$this->suffix;
                        $output .= '<a class="page-numbers" href="'.$base_url.$append.'"'.$attributes.'>'.$loop.'</a>';
                        /*
		...
		if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
		{
            ...
            $attributes = sprintf('%s %s="%d"', $this->_attributes, $this->data_page_attr, $this->cur_page + 1);
            $output .= '<a class="next page-numbers" href="'.$base_url.$this->prefix.$i.$this->suffix.'"'.'>next</a>';
            /*
